...
const VERSION = exports.VERSION = "1.13.5";
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          ...
          (0, _alert.showAlert)('error', 'try logging out again');
        case 3:
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"updateSetting.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " settings updated successfully"));
          }
          _context.n = 3;
          break;
        case 2:
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*eslint-disabled*/
// import Stripe from 'stripe';
var stripe = Stripe('pk_test_51T5LPE06nUVWz21fZhkWk5qalwMP6hD8zkdLJqu0Z3ysAu2D3tym6gd09Vmz4eOOhENf2U1YmF14bjG4LTwRjXvx00j7ofwaNK');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("http://127.0.0.1:4000/api/v1/bookings/checkoutSession/".concat(tourId), {
